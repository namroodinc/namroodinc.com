...
export const playingAreaConfig = {
  soccer: {
    ...
    padding: 20,
    decorators: ({ width, height, strokeColor, strokeWidth }) => (
      <>
        <g>
          <rect
            x={0}
    ...
    half: ({ width, height, strokeColor, strokeWidth, fillColor }) => (
      <>
        <path
          d={d3.arc()({
            innerRadius: 0,
  ...
  basketball: {
    ...
    padding: 20,
    decorators: ({ width, height, strokeColor, strokeWidth, fillColor }) => (
      <>
        <g>
          <rect
            x={0}
